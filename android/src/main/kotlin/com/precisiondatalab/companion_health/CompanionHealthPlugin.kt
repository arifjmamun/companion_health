package com.precisiondatalab.companion_health
...
const val GOOGLE_FIT_PERMISSIONS_REQUEST_CODE = 123456

class CompanionHealthPlugin(val activity: Activity, val channel: MethodChannel): MethodCallHandler, ActivityResultListener, Result {
